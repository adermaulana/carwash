                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-md-6 grid-margin stretch-card">
                                ...
                                <div class="card-body">
                                    <form class="forms-sample" method="POST">
                                        <div class="form-group">
                                            ...
                                            <select name="id_customer_221061" class="js-example-basic-single"
                            ...
                            ?>
                                                <option value="<?= $data['id_customer_221061'] ?>">
                                                    <?= $data['nama_221061'] ?></option>
                                                <?php
                            endwhile; 
                        ?>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="id_jenis_cucian_221061" id="layanan" class="form-select"
                                                required>
                                ...
                                while($data = mysqli_fetch_array($tampil)):
                            ?>
                                                <option value="<?= $data['id_jenis_cucian_221061'] ?>"
                                                    data-harga="<?= $data['biaya_221061'] ?>">
                                                    <?= $data['jenis_cucian_221061'] ?></option>
                                                <?php
                            endwhile; 
                          ?>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="tgl_pendaftaran_221061"
                                                id="tgl_pendaftaran_221061" placeholder="Tanggal Booking" required>
                                        </div>
                                        <div class="form-group">
