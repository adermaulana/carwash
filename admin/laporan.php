                  ...
                  <form method="GET" action="">
                    <div class="row">
                        ...
                        <div class="col-md-6 d-flex align-items-end">
                            ...
                            <a target="_blank" href="cetak_pdf.php?start_date=<?= $_GET['start_date'] ?? '' ?>&end_date=<?= $_GET['end_date'] ?? '' ?>" class="btn btn-danger">
                                Cetak PDF
                            </a>
                        </div>
                    </div>
                    ...
                    <table class="table">
                      ...
                      <?php
                            ...
                            $where = "WHERE transaksi_221061.status_221061 = 'Lunas'";
                            
                            if ($start_date && $end_date) {
                                $where .= " AND transaksi_221061.tanggal_221061 BETWEEN '$start_date' AND '$end_date'";
                            }
