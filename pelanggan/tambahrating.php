                        ...
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <form class="forms-sample" method="POST">
                                        <input type="hidden" name="id_customer_221061"
                          ...
                          ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div id="ratingError" class="error-message">Rating belum dipilih</div>
                                        </div>
                                        <div class="form-group">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            form.addEventListener('submit', function(event) {
                ...
                if (!isRatingSelected) {
                    ...
                    alert('Silahkan pilih rating terlebih dahulu!');
                } else {
            ...
            // Optional: Hide error message when a rating is selected
